...
f_indextodelete = open('/Users/chen/PycharmProjects/ICC_2020_forward secure_verifiable/index_to_delete.txt', mode = 'rb')
index_to_delete=pickle.load(f_indextodelete)

f_k_test = open('/Users/chen/PycharmProjects/ICC_2020_forward secure_verifiable/k_test.txt', mode = 'rb')
...
f_str_basearray = open('/Users/chen/PycharmProjects/ICC_2020_forward secure_verifiable/str_basearray.txt', mode = 'wb')
pickle.dump(str_basearray,f_str_basearray)
f_str_basearray.close()
f_str_deviationarray = open('/Users/chen/PycharmProjects/ICC_2020_forward secure_verifiable/str_deviationarray.txt', mode = 'wb')
