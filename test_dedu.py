...
def dedup(Fog_receive,g,pairing,sk_fog,regis,I_fog,pk_c,I_cloud,cloud_store,basetable,time):
    for eachSD in Fog_receive:
        ...
        linshi = Element(pairing, G2, value=((t2 / t1pie)))
        print('linshi',linshi)
        ftb=Element(pairing, G2, value=(reg*(t2/t1pie)))
        print('ftb',ftb)
...
if __name__=="__main__":
    ...
    I_cloud={}
    basetable={}
    dedup(Fog_receive, g, pairing, sk_fog, regis, I_fog, pk_c, I_cloud, cloud_store, basetable, 1)
